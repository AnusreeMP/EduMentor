...
urlpatterns = [
    ...
    path("api/courses/<int:course_id>/modules/",module_view),
    path('api/courses/<int:course_id>/modules/<int:module_id>/', module_view),
    ...
    path("api/admin/courses/<int:course_id>/modules/",admin_modules,),
    path("api/admin/modules/<int:module_id>/",admin_module_detail,),
    path("api/admin/modules/<int:module_id>/lessons/",admin_lessons),
    path("api/admin/modules/<int:module_id>/lessons/add/",admin_add_lesson),
    path("api/admin/lessons/<int:lesson_id>/edit/",admin_edit_lesson),
    path("api/admin/lessons/<int:lesson_id>/delete/",admin_delete_lesson),
    path("courses/<int:course_id>/modules/", module_list),
    path("courses/<int:course_id>/modules/<int:module_id>/", module_detail),
